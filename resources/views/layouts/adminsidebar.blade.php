...
<aside class="fixed h-screen w-64 bg-gray-900 shadow-lg flex flex-col justify-between border-r-4 border-orange-500">
    ...
    <div class="mb-6 mx-4">
        ...
        <form method="POST" action="{{ route('logout') }}" class="p-2">
            @csrf
            <button type="submit"
                class="w-full bg-orange-500 text-blue-900 p-3 rounded-lg font-extrabold uppercase tracking-wider hover:bg-orange-600 transform hover:scale-105 transition-all"
